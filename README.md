...
**[Code signing policy — מדיניות חתימה](CODE_SIGNING.md)**: בהכנה להגשת בקשה למסלול החינמי של SignPath Foundation; טרם התקבל אישור. **[מדיניות פרטיות / Privacy policy](PRIVACY.md)**.
