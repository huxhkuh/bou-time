...
הקבצים עדיין אינם חתומים בתעודת מפרסם, ולכן Windows עשוי להציג אזהרת מפרסם לא מזוהה. אין צורך לשנות את הגדרות האבטחה. עדכון מתבצע בהפעלה חוזרת של המתקין הקטן אחרי סגירת תמורה; אין עדכון אוטומטי ברקע.
